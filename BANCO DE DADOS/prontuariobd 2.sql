...
INSERT INTO `medico` (`ID_medico`, `nome`, `dt_nasc`, `sexo`, `telefone`, `crm`, `especializacao`, `naturalidade`, `unidade_op`, `endereco`, `cpf`) VALUES
(1, 'Emily da Cruz', '1979-02-07', 'Feminino', '(11) 98795-6135', '3711', 'Dermatologia', 'São Paulo', 'Hospital Serraria', 'Rua Crescente', '909.968.688-95'),
...
(1, 'Jorge Maia', '1997-03-18', 'Masculino', '(16) 99872-6431', 'Vanessa Isadora Melissa', 'Bahia', 'Avenida Francisco de Paula', '468.391.298-88'),
(2, 'João Francisco', '1969-11-15', 'Masculino', '(11) 99899-3767', 'Alice Lara ', 'São Paulo', 'Rua Doutora Idelma ', '495.729.998-69'),
(5, 'Andreia Carolina', '1999-03-01', 'Feminino', '(13) 98659-1019', 'Isabela Alana', 'São Paulo', 'Caminho São Lázaro', '945.993.468-45'),
(6, 'João Carpinteiro', '1989-07-11', 'Masculino', '(16) 99527-9187', 'Aline Lara', 'Rio de Janeiro', 'Rua Marci José', '018.426.768-49');
